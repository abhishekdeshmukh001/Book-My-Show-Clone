    ...
    return (
        <>
            <div className='flex items-center w-full gap-3'>
                ...
                <div className='w-full flex items-center https://i.ibb.co/zPBYW3H/imgbin-bookmyshow-office-android-ticket-png.pnggap-3 bg-white px-3 py-1 rounded-md'>
                    <BiSearch />
                    <input
                        type="search"
        ...
        <>
            <div className='container flex mx-auto px-4 items-center justify-between'>
                ...
                <div className='flex items-center gap-3'>
                    <span className='text-gray-200 text-base flex items-center cursor-pointer hover:text-white'>Nashik <BiChevronDown /></span>
